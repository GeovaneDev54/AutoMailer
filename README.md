...
### Download
You can download the precompiled versions of AutoMailer for different platforms from the releases page:

- [AutoMailer Releases](https://github.com/GeovaneDev54/AutoMailer/releases/tag/v1.0.0)
